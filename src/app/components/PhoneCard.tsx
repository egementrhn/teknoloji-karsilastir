...
export default function PhoneCard({ phone }: PhoneCardProps) {
  ...
  const storageOptions = parseStorageOptions(
    phone.specifications.Memory?.Internal,
  );
        ...
        <div className={styles.specs}>
          <div className={styles.specItem}>
            ...
            <span className={styles.specValue}>
              {phone.specifications.Display?.Size?.split(",")[0] || "N/A"}
            </span>
          </div>
          <div className={styles.specItem}>
            <span className={styles.specLabel}>İşlemci:</span>
            <span className={styles.specValue}>
              {phone.specifications.Platform?.Chipset || "N/A"}
            </span>
          </div>
          <div className={styles.specItem}>
