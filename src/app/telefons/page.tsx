...
export default function Telefons() {
    return (
        <div className="container" style={{ padding: '2rem 1.5rem' }}>
            <header className={styles.header}>
                <h1 className="gradient-text">Tüm Cihazlar</h1>
                <p className={styles.subtitle}>Sizin için listelediğimiz {mockPhones.length} akıllı telefonu inceleyin.</p>
            </header>
            ...
            <div className={styles.layout}>
                ...
                <aside className={`glass-panel ${styles.sidebar}`}>
                    ...
                    <div className={styles.filterGroup}>
                        ...
                        <input type="range" className={styles.rangeInput} min="10000" max="100000" />
                ...
                <main className={styles.main}>
                    <div className={styles.actionBar}>
                        <span className={styles.resultCount}><strong>{mockPhones.length}</strong> sonuç bulundu</span>
